...
function FormMessage({ 
  ...
  return (
    <p
      ...
      {...props}
    >
      {showIcon && <WarningCircle className="size-4 shrink-0" weight="fill" />}
      {body}
    </p>
  )
}

// FormSection - For grouping related form fields
// Sub-title hierarchy: smaller than CardTitle (text-base vs text-xl) but same weight
    ...
    >
      {(title || description) && (
        <div className="space-y-1">
          {title && <h3 className="text-base leading-none font-semibold">{title}</h3>}
