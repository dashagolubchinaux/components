...
function NavigationMenuTrigger({
  ...
  return (
    ...
    >
      {children}{" "}
      <CaretDown
        className="relative top-[1px] ml-1 size-4 transition-transform duration-200 group-data-[state=open]:rotate-180"
        aria-hidden="true"
        weight="bold"
      />
    </NavigationMenuPrimitive.Trigger>
...
function NavigationMenuViewport({
  ...
  return (
    <div
      className={cn(
        "absolute top-full left-0 isolate z-50 flex justify-center perspective-[2000px]"
      )}
    >
      <NavigationMenuPrimitive.Viewport
        data-slot="navigation-menu-viewport"
        className={cn(
          "origin-top-center bg-card text-popover-foreground data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-90 relative mt-2 w-full rounded-xl border border-border shadow-lg md:w-[var(--radix-navigation-menu-viewport-width)]",
          className
        )}
        {...props}
      />
