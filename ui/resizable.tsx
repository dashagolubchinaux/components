...
function ResizablePanelGroup({
  ...
  return (
    <Group
      ...
      className={cn(
        "flex h-full w-full data-[panel-group-direction=vertical]:flex-col font-sans",
        className
      )}
      {...props}
    />
...
function ResizableHandle({
  ...
  return (
    ...
    >
      {withHandle && (
        <div className="bg-border hover:bg-primary/20 z-10 flex h-5 w-4 items-center justify-center rounded-md border border-border transition-colors">
          <DragHandleDots2Icon className="size-3 text-muted-foreground" />
        </div>
      )}
    </Separator>
  )
